...
<div class="container-fluid">
  ...
  <form role="form" action="admin_updProduct.jsp">
   <div class="form-group">
     <div class="row">
      <div class="col-xs-4">
      <label for="upd_id">Product id</label>
      <input type="text" class="form-control" name="upd_id" placeholder="enter product id to update" required>
      </div></div>
      </div>
