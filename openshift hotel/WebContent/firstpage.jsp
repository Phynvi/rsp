  ...
  <div class="container-fluid" >
    ...
    <div>
      <ul class="nav navbar-nav">
        <li class="active"><a href="firstpage.jsp" style="color:#a58b60">Home</a></li>
        
        <li><a href="reservation.jsp" style="color:#a58b60">Reserve</a></li>
        <li><a href="Movies.jsp" style="color:#a58b60">Movies</a></li>
       
         <li ><a href="contact.jsp" style="color:#a58b60">Contact</a></li>             
  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
      <div class="item active">
        <img src="img/image1.jpg" alt="Chania" width="1400" height="550">
      </div>

      <div class="item">
        <img src="img/image2.jpg" alt="Chania" width="1400" height="550">
      </div>
    
      <div class="item">
        <img src="img/image3.jpg" alt="Flower" width="1400" height="550">
      </div>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<iframe width="250" height="250" src="https://www.youtube.com/embed/FC5FbmsH4fw" frameborder="0" allowfullscreen></iframe>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<iframe width="250" height="250" src="https://www.youtube.com/embed/Bb_42qNaE2E" frameborder="0" allowfullscreen></iframe>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<iframe width="250" height="250" src="https://www.youtube.com/embed/f4bTVZWTTao" frameborder="0" allowfullscreen></iframe>
